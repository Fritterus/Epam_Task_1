...
{
    /// <summary>
    /// Class describing behavior king figure
    /// </summary>
    internal class King : Figure
    {
        /// <summary>
        /// Constructor initializes color and type figure for king figure
        /// </summary>
        ...
        /// <summary>
        /// Method discribing rule of move for king
        /// </summary>
        /// <param name="x1">Start X-coordinate </param>
        /// <param name="y1">Start Y-coordinate</param>
        /// <param name="x2">End X-coordinate</param>
        /// <param name="y2">End Y-coordinate</param>
        /// <returns>True, if coordinates correspond king's move, otherwise - false</returns>
        ...
        /// <summary>
        /// Method for finding path of king
        /// </summary>
        /// <param name="x1">Start X-coordinate </param>
        /// <param name="y1">Start Y-coordinate</param>
        /// <param name="x2">End X-coordinate</param>
